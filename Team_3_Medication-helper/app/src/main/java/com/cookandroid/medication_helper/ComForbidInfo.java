/****************************
 ...
 설명 : 환자 - 선택한 약품에 대해 병용금기 정보를 보여줍니다.
 ***************************/
...
public class ComForbidInfo extends AppCompatActivity {
    /* 의약품DB를 사용하기 위한 변수들 */
    String data;
    ...
    public void onBackPressed() {
        super.onBackPressed();
        Intent Back = new Intent(ComForbidInfo.this, MedicineListActivity.class); // 복용 약 목록으로 돌아가는 기능
    ...
    protected void onCreate(Bundle savedInstanceState) {
            ...
            public void run() {
                ...
                ref.child(medicname).addListenerForSingleValueEvent(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot snapshot) {
                        if (snapshot.hasChild("cForbid")) {
                            name.setText(medicname);
                            final String cForbid = snapshot.child("cForbid").getValue(String.class);
        ...
        btnOK.setOnClickListener(new View.OnClickListener() { // 뒤로가기 버튼을 눌렀을 경우
            ...
            public void onClick(View view) {
                Intent intent = new Intent(ComForbidInfo.this, MedicineListActivity.class); // 이전 화면으로 돌아가는 동작
