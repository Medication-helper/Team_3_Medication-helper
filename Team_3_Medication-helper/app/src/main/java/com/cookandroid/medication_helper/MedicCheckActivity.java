...
public class MedicCheckActivity extends AppCompatActivity {
    ...
    public void onBackPressed() {  // 하단의 뒤로가기 버튼을 눌렀을 시 동작
        super.onBackPressed();
        Intent BackToMain = new Intent(MedicCheckActivity.this, com.cookandroid.medication_helper.MainPageActivity.class); // 메인화면으로 돌아가는 기능
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnMedilist.setOnClickListener(new View.OnClickListener() { // 클릭 시 약 목록 조회 페이지로 이동
            ...
            public void onClick(View view) {
                Intent intent = new Intent(MedicCheckActivity.this, com.cookandroid.medication_helper.MedicineListActivity.class);
        ...
        btnFBcom.setOnClickListener(new View.OnClickListener() { // 클릭 시 병용 금지 약물 조회 페이지로 이동
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(MedicCheckActivity.this, com.cookandroid.medication_helper.ComForbiddenListActivity.class);
                startActivity(intent);
                finish();
            }
        });
        btnFBpreg.setOnClickListener(new View.OnClickListener() { // 클릭 시 임부 금지 약물 조회 페이지로 이동
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(MedicCheckActivity.this, com.cookandroid.medication_helper.PregnantForbiddenListActivity.class);
                startActivity(intent);
                finish();
            }
        });
        btnFBage.setOnClickListener(new View.OnClickListener() { // 클릭 시 효능 중복 약물 조회 페이지로 이동
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(MedicCheckActivity.this, com.cookandroid.medication_helper.DuplicateListActivity.class);
                startActivity(intent);
                finish();
            }
        });
        ...
        btnMainPage.setOnClickListener(new View.OnClickListener() { // 클릭 시 메인 페이지로 이동
            @Override
            public void onClick(View view) {
                Intent BackToMain = new Intent(MedicCheckActivity.this, com.cookandroid.medication_helper.MainPageActivity.class);
